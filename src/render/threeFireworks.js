...
const BUILD = 'B331';  // tampon de version affiché dans le HUD -> permet de voir si le navigateur sert du CACHE
...
const EFFECTS = {
  ...
  bombRouge: { apex:42, cal:30, heat:false, pureColor:true, color:RED, gravStar:0.7, dragStar:0.70, lifeBase75:2.4, lifeJitter:0.15, restExtra:1,   // B330 (user) : physique pivoine — punch bref puis les étoiles SE FIGENT (elles filaient trop)
            stars:34, starSize:1.55, speedMul:0.82, riseLean:2.5, riseTrail:false, headSize:0.7, riseColor:new THREE.Color(0.55,0.40,0.20),   // B331 (user) : encore plus d'étoiles (34), plus petites (1.55)
            noFlash:true, burstSparks:false },
