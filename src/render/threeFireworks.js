...
const BUILD = 'B121';  // tampon de version affiché dans le HUD -> permet de voir si le navigateur sert du CACHE
...
const EFFECTS = {
  ...
  fallingLeaves: { apex:95, dist:distLeaves, heat:false, color:new THREE.Color(1.0,0.45,0.55),
                   gravStar:0.58, dragStar:0.5, lifeBase75:6.0, speedMul:0.7, sway:2.5, wind:2.5, noRise:true, starSize:2.4 },   // B121 (user) : descente un poil + rapide (~5,5 m/s) ; vent commun + tangage ; presque jamais vers le haut
